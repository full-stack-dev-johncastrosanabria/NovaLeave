...
- **OQ-004 — Mandatory reason for deactivation** *(Documented as OUT OF MVP SCOPE)*: Whether Approver deactivation of an approved request requires a human-entered reason is undefined.
  
  > **Out of MVP Scope**: The MVP does not introduce a mandatory deactivation-reason requirement until an approved specification exists. Do not invent new requirements.
