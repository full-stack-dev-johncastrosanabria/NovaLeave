# TASK-021 - Create movement type enum
...
Deliver the outcome defined by canonical task T021: Create movement type enum.

## Description

This task is a derived execution view of $(@{Id=21; OfficialId=T021; TaskId=TASK-021; Raw=Create movement type enum in `src/NovaLeave.Domain/Enums/MovementType.cs`; Name=Create movement type enum; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=21; OfficialId=T021; TaskId=TASK-021; Raw=Create movement type enum in `src/NovaLeave.Domain/Enums/MovementType.cs`; Name=Create movement type enum; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=21; OfficialId=T021; TaskId=TASK-021; Raw=Create movement type enum in `src/NovaLeave.Domain/Enums/MovementType.cs`; Name=Create movement type enum; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=21; OfficialId=T021; TaskId=TASK-021; Raw=Create movement type enum in `src/NovaLeave.Domain/Enums/MovementType.cs`; Name=Create movement type enum; IsParallel=False; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Create movement type enum.
- Expected files or folders:
- `src/NovaLeave.Domain/Enums/MovementType.cs`
...
- [ ] The deliverable described by $(@{Id=21; OfficialId=T021; TaskId=TASK-021; Raw=Create movement type enum in `src/NovaLeave.Domain/Enums/MovementType.cs`; Name=Create movement type enum; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=21; OfficialId=T021; TaskId=TASK-021; Raw=Create movement type enum in `src/NovaLeave.Domain/Enums/MovementType.cs`; Name=Create movement type enum; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Domain/Enums/MovementType.cs`
- Original task: $(@{Id=21; OfficialId=T021; TaskId=TASK-021; Raw=Create movement type enum in `src/NovaLeave.Domain/Enums/MovementType.cs`; Name=Create movement type enum; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
