# TASK-031 - Create immutable AuditRecord entity with redaction-ready Data field
...
- Deliver only: Create immutable AuditRecord entity with redaction-ready Data field.
- Expected files or folders:
- `src/NovaLeave.Domain/Entities/AuditRecord.cs`
...
- Planned path: `src/NovaLeave.Domain/Entities/AuditRecord.cs`
- Original task: $(@{Id=31; OfficialId=T031; TaskId=TASK-031; Raw=Create immutable AuditRecord entity with redaction-ready Data field in `src/NovaLeave.Domain/Entities/AuditRecord.cs`; Name=Create immutable AuditRecord entity with redaction-ready Data field; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
