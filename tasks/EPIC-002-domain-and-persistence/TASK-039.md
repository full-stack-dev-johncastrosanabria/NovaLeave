# TASK-039 - Create EF Core DbContext shell
...
Deliver the outcome defined by canonical task T039: Create EF Core DbContext shell.

## Description

This task is a derived execution view of $(@{Id=39; OfficialId=T039; TaskId=TASK-039; Raw=Create EF Core DbContext shell in `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`; Name=Create EF Core DbContext shell; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=39; OfficialId=T039; TaskId=TASK-039; Raw=Create EF Core DbContext shell in `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`; Name=Create EF Core DbContext shell; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=39; OfficialId=T039; TaskId=TASK-039; Raw=Create EF Core DbContext shell in `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`; Name=Create EF Core DbContext shell; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=39; OfficialId=T039; TaskId=TASK-039; Raw=Create EF Core DbContext shell in `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`; Name=Create EF Core DbContext shell; IsParallel=False; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Create EF Core DbContext shell.
- Expected files or folders:
- `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`
...
- [ ] The deliverable described by $(@{Id=39; OfficialId=T039; TaskId=TASK-039; Raw=Create EF Core DbContext shell in `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`; Name=Create EF Core DbContext shell; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=39; OfficialId=T039; TaskId=TASK-039; Raw=Create EF Core DbContext shell in `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`; Name=Create EF Core DbContext shell; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`
- Original task: $(@{Id=39; OfficialId=T039; TaskId=TASK-039; Raw=Create EF Core DbContext shell in `src/NovaLeave.Infrastructure/Persistence/NovaLeaveDbContext.cs`; Name=Create EF Core DbContext shell; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
