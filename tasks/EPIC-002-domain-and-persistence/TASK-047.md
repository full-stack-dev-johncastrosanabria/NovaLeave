# TASK-047 - Register EF Core SQL Server DbContext
...
Deliver the outcome defined by canonical task T047: Register EF Core SQL Server DbContext.

## Description

This task is a derived execution view of $(@{Id=47; OfficialId=T047; TaskId=TASK-047; Raw=Register EF Core SQL Server DbContext in `src/NovaLeave.Infrastructure/DependencyInjection.cs`; Name=Register EF Core SQL Server DbContext; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=47; OfficialId=T047; TaskId=TASK-047; Raw=Register EF Core SQL Server DbContext in `src/NovaLeave.Infrastructure/DependencyInjection.cs`; Name=Register EF Core SQL Server DbContext; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=47; OfficialId=T047; TaskId=TASK-047; Raw=Register EF Core SQL Server DbContext in `src/NovaLeave.Infrastructure/DependencyInjection.cs`; Name=Register EF Core SQL Server DbContext; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=47; OfficialId=T047; TaskId=TASK-047; Raw=Register EF Core SQL Server DbContext in `src/NovaLeave.Infrastructure/DependencyInjection.cs`; Name=Register EF Core SQL Server DbContext; IsParallel=False; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Register EF Core SQL Server DbContext.
...
- [ ] The deliverable described by $(@{Id=47; OfficialId=T047; TaskId=TASK-047; Raw=Register EF Core SQL Server DbContext in `src/NovaLeave.Infrastructure/DependencyInjection.cs`; Name=Register EF Core SQL Server DbContext; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=47; OfficialId=T047; TaskId=TASK-047; Raw=Register EF Core SQL Server DbContext in `src/NovaLeave.Infrastructure/DependencyInjection.cs`; Name=Register EF Core SQL Server DbContext; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Original task: $(@{Id=47; OfficialId=T047; TaskId=TASK-047; Raw=Register EF Core SQL Server DbContext in `src/NovaLeave.Infrastructure/DependencyInjection.cs`; Name=Register EF Core SQL Server DbContext; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
