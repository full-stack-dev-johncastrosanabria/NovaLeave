# TASK-037 - Create typed configuration model
...
Deliver the outcome defined by canonical task T037: Create typed configuration model.

## Description

This task is a derived execution view of $(@{Id=37; OfficialId=T037; TaskId=TASK-037; Raw=Create typed configuration model in `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`; Name=Create typed configuration model; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=37; OfficialId=T037; TaskId=TASK-037; Raw=Create typed configuration model in `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`; Name=Create typed configuration model; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=37; OfficialId=T037; TaskId=TASK-037; Raw=Create typed configuration model in `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`; Name=Create typed configuration model; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=37; OfficialId=T037; TaskId=TASK-037; Raw=Create typed configuration model in `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`; Name=Create typed configuration model; IsParallel=False; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Create typed configuration model.
- Expected files or folders:
- `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`
...
- [ ] The deliverable described by $(@{Id=37; OfficialId=T037; TaskId=TASK-037; Raw=Create typed configuration model in `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`; Name=Create typed configuration model; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=37; OfficialId=T037; TaskId=TASK-037; Raw=Create typed configuration model in `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`; Name=Create typed configuration model; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`
- Original task: $(@{Id=37; OfficialId=T037; TaskId=TASK-037; Raw=Create typed configuration model in `src/NovaLeave.Application/Configuration/NovaLeaveOptions.cs`; Name=Create typed configuration model; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
