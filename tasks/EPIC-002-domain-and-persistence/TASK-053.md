# TASK-053 - Create shared status badge partial
...
Deliver the outcome defined by canonical task T053: Create shared status badge partial.

## Description

This task is a derived execution view of $(@{Id=53; OfficialId=T053; TaskId=TASK-053; Raw=Create shared status badge partial in `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`; Name=Create shared status badge partial; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=53; OfficialId=T053; TaskId=TASK-053; Raw=Create shared status badge partial in `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`; Name=Create shared status badge partial; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=53; OfficialId=T053; TaskId=TASK-053; Raw=Create shared status badge partial in `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`; Name=Create shared status badge partial; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=53; OfficialId=T053; TaskId=TASK-053; Raw=Create shared status badge partial in `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`; Name=Create shared status badge partial; IsParallel=False; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Create shared status badge partial.
- Expected files or folders:
- `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`
...
- [ ] The deliverable described by $(@{Id=53; OfficialId=T053; TaskId=TASK-053; Raw=Create shared status badge partial in `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`; Name=Create shared status badge partial; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=53; OfficialId=T053; TaskId=TASK-053; Raw=Create shared status badge partial in `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`; Name=Create shared status badge partial; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`
- Original task: $(@{Id=53; OfficialId=T053; TaskId=TASK-053; Raw=Create shared status badge partial in `src/NovaLeave.Presentation.Web/Views/Shared/_StatusBadge.cshtml`; Name=Create shared status badge partial; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
