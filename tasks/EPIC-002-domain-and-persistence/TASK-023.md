...
Deliver the outcome defined by canonical task T023: Create DateRange value object in `src/NovaLeave.Domain/ValueObjects/DateRange.cs`.

## Description

This task is a derived execution view of T023 from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item T023 executable without changing the approved scope. Original canonical text: Create DateRange value object in `src/NovaLeave.Domain/ValueObjects/DateRange.cs`.
...
- Preserve the original canonical task identifier T023.
...
- [ ] The deliverable described by T023 exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to T023 and the listed requirements/use cases is preserved.
...
- Original task: T023 from specs/001-leave-management-mvp/tasks.md.
