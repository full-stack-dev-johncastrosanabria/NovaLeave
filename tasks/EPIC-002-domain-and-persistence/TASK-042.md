# TASK-042 - Create BalanceMovement EF Core mapping
...
Deliver the outcome defined by canonical task T042: Create BalanceMovement EF Core mapping.

## Description

This task is a derived execution view of $(@{Id=42; OfficialId=T042; TaskId=TASK-042; Raw=Create BalanceMovement EF Core mapping in `src/NovaLeave.Infrastructure/Persistence/Configurations/BalanceMovementConfiguration.cs`; Name=Create BalanceMovement EF Core mapping; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=42; OfficialId=T042; TaskId=TASK-042; Raw=Create BalanceMovement EF Core mapping in `src/NovaLeave.Infrastructure/Persistence/Configurations/BalanceMovementConfiguration.cs`; Name=Create BalanceMovement EF Core mapping; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=42; OfficialId=T042; TaskId=TASK-042; Raw=Create BalanceMovement EF Core mapping in `src/NovaLeave.Infrastructure/Persistence/Configurations/BalanceMovementConfiguration.cs`; Name=Create BalanceMovement EF Core mapping; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- [ ] The deliverable described by $(@{Id=42; OfficialId=T042; TaskId=TASK-042; Raw=Create BalanceMovement EF Core mapping in `src/NovaLeave.Infrastructure/Persistence/Configurations/BalanceMovementConfiguration.cs`; Name=Create BalanceMovement EF Core mapping; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=42; OfficialId=T042; TaskId=TASK-042; Raw=Create BalanceMovement EF Core mapping in `src/NovaLeave.Infrastructure/Persistence/Configurations/BalanceMovementConfiguration.cs`; Name=Create BalanceMovement EF Core mapping; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Original task: $(@{Id=42; OfficialId=T042; TaskId=TASK-042; Raw=Create BalanceMovement EF Core mapping in `src/NovaLeave.Infrastructure/Persistence/Configurations/BalanceMovementConfiguration.cs`; Name=Create BalanceMovement EF Core mapping; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
