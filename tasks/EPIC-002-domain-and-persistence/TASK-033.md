# TASK-033 - Create Application authorization facade abstraction
...
- Deliver only: Create Application authorization facade abstraction.
- Expected files or folders:
- `src/NovaLeave.Application/Common/Interfaces/IAuthorizationServiceFacade.cs`
...
- Planned path: `src/NovaLeave.Application/Common/Interfaces/IAuthorizationServiceFacade.cs`
- Original task: $(@{Id=33; OfficialId=T033; TaskId=TASK-033; Raw=Create Application authorization facade abstraction in `src/NovaLeave.Application/Common/Interfaces/IAuthorizationServiceFacade.cs`; Name=Create Application authorization facade abstraction; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
