# TASK-022 - Create Vacation-only leave type enum or constant
...
Deliver the outcome defined by canonical task T022: Create Vacation-only leave type enum or constant.

## Description

This task is a derived execution view of $(@{Id=22; OfficialId=T022; TaskId=TASK-022; Raw=Create Vacation-only leave type enum or constant in `src/NovaLeave.Domain/Enums/LeaveType.cs`; Name=Create Vacation-only leave type enum or constant; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=22; OfficialId=T022; TaskId=TASK-022; Raw=Create Vacation-only leave type enum or constant in `src/NovaLeave.Domain/Enums/LeaveType.cs`; Name=Create Vacation-only leave type enum or constant; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=22; OfficialId=T022; TaskId=TASK-022; Raw=Create Vacation-only leave type enum or constant in `src/NovaLeave.Domain/Enums/LeaveType.cs`; Name=Create Vacation-only leave type enum or constant; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=22; OfficialId=T022; TaskId=TASK-022; Raw=Create Vacation-only leave type enum or constant in `src/NovaLeave.Domain/Enums/LeaveType.cs`; Name=Create Vacation-only leave type enum or constant; IsParallel=False; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Create Vacation-only leave type enum or constant.
- Expected files or folders:
- `src/NovaLeave.Domain/Enums/LeaveType.cs`
...
- [ ] The deliverable described by $(@{Id=22; OfficialId=T022; TaskId=TASK-022; Raw=Create Vacation-only leave type enum or constant in `src/NovaLeave.Domain/Enums/LeaveType.cs`; Name=Create Vacation-only leave type enum or constant; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=22; OfficialId=T022; TaskId=TASK-022; Raw=Create Vacation-only leave type enum or constant in `src/NovaLeave.Domain/Enums/LeaveType.cs`; Name=Create Vacation-only leave type enum or constant; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Domain/Enums/LeaveType.cs`
- Original task: $(@{Id=22; OfficialId=T022; TaskId=TASK-022; Raw=Create Vacation-only leave type enum or constant in `src/NovaLeave.Domain/Enums/LeaveType.cs`; Name=Create Vacation-only leave type enum or constant; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
