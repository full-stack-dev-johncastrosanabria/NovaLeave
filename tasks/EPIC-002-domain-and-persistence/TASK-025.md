...
Deliver the outcome defined by canonical task T025: Create AccrualPeriod value object.

## Description

This task is a derived execution view of $(@{Id=25; OfficialId=T025; TaskId=TASK-025; Raw=Create AccrualPeriod value object in `src/NovaLeave.Domain/ValueObjects/AccrualPeriod.cs`; Name=Create AccrualPeriod value object; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=25; OfficialId=T025; TaskId=TASK-025; Raw=Create AccrualPeriod value object in `src/NovaLeave.Domain/ValueObjects/AccrualPeriod.cs`; Name=Create AccrualPeriod value object; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=25; OfficialId=T025; TaskId=TASK-025; Raw=Create AccrualPeriod value object in `src/NovaLeave.Domain/ValueObjects/AccrualPeriod.cs`; Name=Create AccrualPeriod value object; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=25; OfficialId=T025; TaskId=TASK-025; Raw=Create AccrualPeriod value object in `src/NovaLeave.Domain/ValueObjects/AccrualPeriod.cs`; Name=Create AccrualPeriod value object; IsParallel=False; US=; Paths=System.Object[]}.OfficialId).
...
- [ ] The deliverable described by $(@{Id=25; OfficialId=T025; TaskId=TASK-025; Raw=Create AccrualPeriod value object in `src/NovaLeave.Domain/ValueObjects/AccrualPeriod.cs`; Name=Create AccrualPeriod value object; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=25; OfficialId=T025; TaskId=TASK-025; Raw=Create AccrualPeriod value object in `src/NovaLeave.Domain/ValueObjects/AccrualPeriod.cs`; Name=Create AccrualPeriod value object; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Original task: $(@{Id=25; OfficialId=T025; TaskId=TASK-025; Raw=Create AccrualPeriod value object in `src/NovaLeave.Domain/ValueObjects/AccrualPeriod.cs`; Name=Create AccrualPeriod value object; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
