# TASK-032 - Create Application DbContext abstraction
...
Deliver the outcome defined by canonical task T032: Create Application DbContext abstraction.

## Description

This task is a derived execution view of $(@{Id=32; OfficialId=T032; TaskId=TASK-032; Raw=Create Application DbContext abstraction in `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`; Name=Create Application DbContext abstraction; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=32; OfficialId=T032; TaskId=TASK-032; Raw=Create Application DbContext abstraction in `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`; Name=Create Application DbContext abstraction; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=32; OfficialId=T032; TaskId=TASK-032; Raw=Create Application DbContext abstraction in `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`; Name=Create Application DbContext abstraction; IsParallel=False; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=32; OfficialId=T032; TaskId=TASK-032; Raw=Create Application DbContext abstraction in `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`; Name=Create Application DbContext abstraction; IsParallel=False; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Create Application DbContext abstraction.
- Expected files or folders:
- `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`
...
- [ ] The deliverable described by $(@{Id=32; OfficialId=T032; TaskId=TASK-032; Raw=Create Application DbContext abstraction in `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`; Name=Create Application DbContext abstraction; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=32; OfficialId=T032; TaskId=TASK-032; Raw=Create Application DbContext abstraction in `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`; Name=Create Application DbContext abstraction; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`
- Original task: $(@{Id=32; OfficialId=T032; TaskId=TASK-032; Raw=Create Application DbContext abstraction in `src/NovaLeave.Application/Common/Interfaces/IApplicationDbContext.cs`; Name=Create Application DbContext abstraction; IsParallel=False; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
