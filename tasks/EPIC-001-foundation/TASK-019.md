# TASK-019 - Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence
...
Deliver the outcome defined by canonical task T019: Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence.

## Description

This task is a derived execution view of $(@{Id=19; OfficialId=T019; TaskId=TASK-019; Raw=[P] Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence in `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`; Name=Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=19; OfficialId=T019; TaskId=TASK-019; Raw=[P] Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence in `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`; Name=Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=19; OfficialId=T019; TaskId=TASK-019; Raw=[P] Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence in `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`; Name=Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence; IsParallel=True; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=19; OfficialId=T019; TaskId=TASK-019; Raw=[P] Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence in `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`; Name=Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence; IsParallel=True; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence.
- Expected files or folders:
- `NovaLeave:PendingRequestTimeoutDays`
- `NovaLeave:SessionTimeoutMinutes`
- `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`
...
- [ ] The deliverable described by $(@{Id=19; OfficialId=T019; TaskId=TASK-019; Raw=[P] Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence in `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`; Name=Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=19; OfficialId=T019; TaskId=TASK-019; Raw=[P] Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence in `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`; Name=Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`
- Original task: $(@{Id=19; OfficialId=T019; TaskId=TASK-019; Raw=[P] Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence in `tests/NovaLeave.UnitTests/Configuration/NovaLeaveOptionsTests.cs`; Name=Add configuration validation tests for `NovaLeave:PendingRequestTimeoutDays`, `NovaLeave:SessionTimeoutMinutes`, and accrual scheduler cadence; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
