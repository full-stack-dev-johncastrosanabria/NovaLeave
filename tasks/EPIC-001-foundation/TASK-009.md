...
Deliver the outcome defined by canonical task T009: [P] Configure Serilog package references in `src/NovaLeave.Infrastructure/NovaLeave.Infrastructure.csproj` and `src/NovaLeave.Presentation.Web/NovaLeave.Presentation.Web.csproj`.

## Description

This task is a derived execution view of T009 from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item T009 executable without changing the approved scope. Original canonical text: [P] Configure Serilog package references in `src/NovaLeave.Infrastructure/NovaLeave.Infrastructure.csproj` and `src/NovaLeave.Presentation.Web/NovaLeave.Presentation.Web.csproj`.
...
- Preserve the original canonical task identifier T009.
...
- [ ] The deliverable described by T009 exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to T009 and the listed requirements/use cases is preserved.
...
- Original task: T009 from specs/001-leave-management-mvp/tasks.md.
