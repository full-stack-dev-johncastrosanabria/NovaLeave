# TASK-016 - Add balance invariant tests for non-negative accrued/reserved/deducted/available totals
...
Deliver the outcome defined by canonical task T016: Add balance invariant tests for non-negative accrued/reserved/deducted/available totals.

## Description

This task is a derived execution view of $(@{Id=16; OfficialId=T016; TaskId=TASK-016; Raw=[P] Add balance invariant tests for non-negative accrued/reserved/deducted/available totals in `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`; Name=Add balance invariant tests for non-negative accrued/reserved/deducted/available totals; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=16; OfficialId=T016; TaskId=TASK-016; Raw=[P] Add balance invariant tests for non-negative accrued/reserved/deducted/available totals in `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`; Name=Add balance invariant tests for non-negative accrued/reserved/deducted/available totals; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=16; OfficialId=T016; TaskId=TASK-016; Raw=[P] Add balance invariant tests for non-negative accrued/reserved/deducted/available totals in `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`; Name=Add balance invariant tests for non-negative accrued/reserved/deducted/available totals; IsParallel=True; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=16; OfficialId=T016; TaskId=TASK-016; Raw=[P] Add balance invariant tests for non-negative accrued/reserved/deducted/available totals in `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`; Name=Add balance invariant tests for non-negative accrued/reserved/deducted/available totals; IsParallel=True; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Add balance invariant tests for non-negative accrued/reserved/deducted/available totals.
- Expected files or folders:
- `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`
...
- [ ] The deliverable described by $(@{Id=16; OfficialId=T016; TaskId=TASK-016; Raw=[P] Add balance invariant tests for non-negative accrued/reserved/deducted/available totals in `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`; Name=Add balance invariant tests for non-negative accrued/reserved/deducted/available totals; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=16; OfficialId=T016; TaskId=TASK-016; Raw=[P] Add balance invariant tests for non-negative accrued/reserved/deducted/available totals in `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`; Name=Add balance invariant tests for non-negative accrued/reserved/deducted/available totals; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`
- Original task: $(@{Id=16; OfficialId=T016; TaskId=TASK-016; Raw=[P] Add balance invariant tests for non-negative accrued/reserved/deducted/available totals in `tests/NovaLeave.UnitTests/Domain/VacationBalanceTests.cs`; Name=Add balance invariant tests for non-negative accrued/reserved/deducted/available totals; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
