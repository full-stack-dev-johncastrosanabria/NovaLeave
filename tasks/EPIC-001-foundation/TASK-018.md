# TASK-018 - Add audit schema and redaction tests
...
Deliver the outcome defined by canonical task T018: Add audit schema and redaction tests.

## Description

This task is a derived execution view of $(@{Id=18; OfficialId=T018; TaskId=TASK-018; Raw=[P] Add audit schema and redaction tests in `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`; Name=Add audit schema and redaction tests; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=18; OfficialId=T018; TaskId=TASK-018; Raw=[P] Add audit schema and redaction tests in `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`; Name=Add audit schema and redaction tests; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=18; OfficialId=T018; TaskId=TASK-018; Raw=[P] Add audit schema and redaction tests in `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`; Name=Add audit schema and redaction tests; IsParallel=True; US=; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=18; OfficialId=T018; TaskId=TASK-018; Raw=[P] Add audit schema and redaction tests in `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`; Name=Add audit schema and redaction tests; IsParallel=True; US=; Paths=System.Object[]}.OfficialId).
- Deliver only: Add audit schema and redaction tests.
- Expected files or folders:
- `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`
...
- [ ] The deliverable described by $(@{Id=18; OfficialId=T018; TaskId=TASK-018; Raw=[P] Add audit schema and redaction tests in `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`; Name=Add audit schema and redaction tests; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=18; OfficialId=T018; TaskId=TASK-018; Raw=[P] Add audit schema and redaction tests in `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`; Name=Add audit schema and redaction tests; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`
- Original task: $(@{Id=18; OfficialId=T018; TaskId=TASK-018; Raw=[P] Add audit schema and redaction tests in `tests/NovaLeave.UnitTests/Domain/AuditRecordTests.cs`; Name=Add audit schema and redaction tests; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
