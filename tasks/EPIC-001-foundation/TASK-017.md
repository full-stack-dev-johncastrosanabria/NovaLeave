...
Deliver the outcome defined by canonical task T017: Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests`.

## Description

This task is a derived execution view of $(@{Id=17; OfficialId=T017; TaskId=TASK-017; Raw=[P] Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests` in `tests/NovaLeave.IntegrationTests/Security/AuthorizationPolicyTests.cs`; Name=Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests`; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=17; OfficialId=T017; TaskId=TASK-017; Raw=[P] Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests` in `tests/NovaLeave.IntegrationTests/Security/AuthorizationPolicyTests.cs`; Name=Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests`; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=17; OfficialId=T017; TaskId=TASK-017; Raw=[P] Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests` in `tests/NovaLeave.IntegrationTests/Security/AuthorizationPolicyTests.cs`; Name=Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests`; IsParallel=True; US=; Paths=System.Object[]}.Raw).
...
- [ ] The deliverable described by $(@{Id=17; OfficialId=T017; TaskId=TASK-017; Raw=[P] Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests` in `tests/NovaLeave.IntegrationTests/Security/AuthorizationPolicyTests.cs`; Name=Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests`; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=17; OfficialId=T017; TaskId=TASK-017; Raw=[P] Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests` in `tests/NovaLeave.IntegrationTests/Security/AuthorizationPolicyTests.cs`; Name=Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests`; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Original task: $(@{Id=17; OfficialId=T017; TaskId=TASK-017; Raw=[P] Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests` in `tests/NovaLeave.IntegrationTests/Security/AuthorizationPolicyTests.cs`; Name=Add authorization policy tests for User, Approver, HR, Active/Inactive, self-resolution denial, and `canResolveRequests`; IsParallel=True; US=; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
