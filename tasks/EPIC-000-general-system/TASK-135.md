# TASK-135 - Derived execution task
...
Deliver the outcome defined by canonical task T135: [US7] Implement dedicated HR read-only ViewModels in `src/NovaLeave.Web/ViewModels/RRHH/`.

## Description

This file is a generated or synchronized execution view of T135 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
