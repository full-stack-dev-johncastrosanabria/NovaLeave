# TASK-117 - Add shared calendar ViewModel unit tests
...
Deliver the outcome defined by canonical task T117: [P] [US6] Add shared calendar ViewModel unit tests in `tests/NovaLeave.UnitTests/Presentation/CalendarViewModelTests.cs`.

## Description

This task is a derived execution view of T117 from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item T117 executable without changing the approved scope. Original canonical text: [P] [US6] Add shared calendar ViewModel unit tests in `tests/NovaLeave.UnitTests/Presentation/CalendarViewModelTests.cs`.
...
- Preserve the original canonical task identifier T117.
- Deliver only: Add shared calendar ViewModel unit tests.
- Expected files or folders:
- `tests/NovaLeave.UnitTests/Presentation/CalendarViewModelTests.cs`
...
- [ ] The deliverable described by T117 exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to T117 and the listed requirements/use cases is preserved.
...
- Planned path: `tests/NovaLeave.UnitTests/Presentation/CalendarViewModelTests.cs`
- Original task: T117 from specs/001-leave-management-mvp/tasks.md.
