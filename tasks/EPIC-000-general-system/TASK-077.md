# TASK-077 - Derived execution task
...
Deliver the outcome defined by canonical task T077: [US1] Wire User navigation and role context switcher in `src/NovaLeave.Web/Views/Shared/_Layout.cshtml`.

## Description

This file is a generated or synchronized execution view of T077 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
