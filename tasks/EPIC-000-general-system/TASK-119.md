# TASK-119 - Add calendar accessibility E2E smoke tests
...
Deliver the outcome defined by canonical task T119: [P] [US6] Add calendar accessibility E2E smoke tests in `tests/NovaLeave.EndToEndTests/Calendar/CalendarAccessibilityTests.cs`.

## Description

This task is a derived execution view of T119 from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item T119 executable without changing the approved scope. Original canonical text: [P] [US6] Add calendar accessibility E2E smoke tests in `tests/NovaLeave.EndToEndTests/Calendar/CalendarAccessibilityTests.cs`.
...
- Preserve the original canonical task identifier T119.
- Deliver only: Add calendar accessibility E2E smoke tests.
- Expected files or folders:
- `tests/NovaLeave.EndToEndTests/Calendar/CalendarAccessibilityTests.cs`
...
- [ ] The deliverable described by T119 exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to T119 and the listed requirements/use cases is preserved.
...
- Planned path: `tests/NovaLeave.EndToEndTests/Calendar/CalendarAccessibilityTests.cs`
- Original task: T119 from specs/001-leave-management-mvp/tasks.md.
