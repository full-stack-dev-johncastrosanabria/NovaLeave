...
Deliver the outcome defined by canonical task T129: [P] [US7] Implement HR request read queries in `src/NovaLeave.Application/HR/Requests/`.

## Description

This task is a derived execution view of T129 from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item T129 executable without changing the approved scope. Original canonical text: [P] [US7] Implement HR request read queries in `src/NovaLeave.Application/HR/Requests/`.
...
- Preserve the original canonical task identifier T129.
...
- [ ] The deliverable described by T129 exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to T129 and the listed requirements/use cases is preserved.
...
- Original task: T129 from specs/001-leave-management-mvp/tasks.md.
