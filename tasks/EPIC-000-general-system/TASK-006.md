# TASK-006 - Derived execution task
...
Deliver the outcome defined by canonical task T006: [P] Configure ASP.NET Core Identity UI package references in `src/NovaLeave.Web/NovaLeave.Web.csproj`.

## Description

This file is a generated or synchronized execution view of T006 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
