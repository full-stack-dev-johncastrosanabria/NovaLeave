# TASK-163 - Derived execution task
...
Deliver the outcome defined by canonical task T163: [P] Add health-check endpoint tests for liveness, readiness, database connectivity, and secret-free responses in `tests/NovaLeave.IntegrationTests/Observability/HealthCheckTests.cs`.

## Description

This file is a generated or synchronized execution view of T163 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
