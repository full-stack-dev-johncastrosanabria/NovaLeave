# TASK-173 - Derived execution task
...
Deliver the outcome defined by canonical task T173: [P] Create database migration and scheduled jobs runbooks in `docs/operations/database-migration-runbook.md` and `docs/operations/scheduled-jobs-runbook.md`.

## Description

This file is a generated or synchronized execution view of T173 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
