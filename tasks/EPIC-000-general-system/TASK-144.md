# TASK-144 - Derived execution task
...
Deliver the outcome defined by canonical task T144: [US8] Implement capability management ViewModels in `src/NovaLeave.Web/ViewModels/RRHH/ApproverCapabilities/`.

## Description

This file is a generated or synchronized execution view of T144 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
