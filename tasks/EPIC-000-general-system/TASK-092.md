# TASK-092 - Derived execution task
...
Deliver the outcome defined by canonical task T092: [US2] Implement dedicated Approver ViewModels in `src/NovaLeave.Web/ViewModels/Aprobaciones/` and `src/NovaLeave.Web/ViewModels/Calendario/`.

## Description

This file is a generated or synchronized execution view of T092 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
