...
Deliver the outcome defined by canonical task T092: [US2] Implement dedicated Approver ViewModels in `src/NovaLeave.Presentation.Web/Models/Approver/`.

## Description

This task is a derived execution view of T092 from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item T092 executable without changing the approved scope. Original canonical text: [US2] Implement dedicated Approver ViewModels in `src/NovaLeave.Presentation.Web/Models/Approver/`.
...
- Preserve the original canonical task identifier T092.
...
- [ ] The deliverable described by T092 exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to T092 and the listed requirements/use cases is preserved.
...
- Original task: T092 from specs/001-leave-management-mvp/tasks.md.
