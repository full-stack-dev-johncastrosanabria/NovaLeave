# TASK-143 - Derived execution task
...
Deliver the outcome defined by canonical task T143: [US8] Implement HR Approver capability MVC controller routes `/rrhh/aprobadores` and `/rrhh/aprobadores/{id}/capacidad` in `src/NovaLeave.Web/Controllers/RRHHController.cs`.

## Description

This file is a generated or synchronized execution view of T143 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
