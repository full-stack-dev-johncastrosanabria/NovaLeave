# TASK-106 - Derived execution task
...
Deliver the outcome defined by canonical task T106: [US4] Add Approver POST route `/aprobaciones/{id}/desactivar` in `src/NovaLeave.Web/Controllers/AprobacionesController.cs`.

## Description

This file is a generated or synchronized execution view of T106 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
