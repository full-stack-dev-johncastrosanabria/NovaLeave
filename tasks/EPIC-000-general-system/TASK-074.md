# TASK-074 - Derived execution task
...
Deliver the outcome defined by canonical task T074: [US1] Implement resource-oriented MVC controllers for `/mis-solicitudes`, `/mis-solicitudes/crear`, `/mis-solicitudes/{id}`, `/saldo`, and User `/calendario` actions in `src/NovaLeave.Web/Controllers/MisSolicitudesController.cs` and `src/NovaLeave.Web/Controllers/CalendarioController.cs`.

## Description

This file is a generated or synchronized execution view of T074 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
