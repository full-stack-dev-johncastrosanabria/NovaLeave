# TASK-122 - Derived execution task
...
Deliver the outcome defined by canonical task T122: [US6] Integrate shared calendar partial into User and Approver `/calendario` views and the dedicated read-only HR `/rrhh/calendario` view without sharing route data scope under `src/NovaLeave.Web/Views/`.

## Description

This file is a generated or synchronized execution view of T122 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
