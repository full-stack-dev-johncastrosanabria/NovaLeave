...
Deliver the outcome defined by canonical task T066: [P] [US1] Add UC-08 personal calendar tests in `tests/NovaLeave.IntegrationTests/UseCases/UC08PersonalCalendarTests.cs`.

## Description

This task is a derived execution view of T066 from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item T066 executable without changing the approved scope. Original canonical text: [P] [US1] Add UC-08 personal calendar tests in `tests/NovaLeave.IntegrationTests/UseCases/UC08PersonalCalendarTests.cs`.
...
- Preserve the original canonical task identifier T066.
...
- [ ] The deliverable described by T066 exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to T066 and the listed requirements/use cases is preserved.
...
- Original task: T066 from specs/001-leave-management-mvp/tasks.md.
