# TASK-012 - Derived execution task
...
Deliver the outcome defined by canonical task T012: Verify `AGENTS.md` Spec Kit section references `specs/001-leave-management-mvp/plan.md`; update only if the reference is missing or stale.

## Description

This file is a generated or synchronized execution view of T012 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
