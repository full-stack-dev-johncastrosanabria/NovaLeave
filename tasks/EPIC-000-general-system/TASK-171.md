# TASK-171 - Derived execution task
...
Deliver the outcome defined by canonical task T171: [P] Create deployment and incident response runbooks in `docs/operations/deployment-runbook.md` and `docs/operations/incident-response-runbook.md` without CI/CD or deployment automation.

## Description

This file is a generated or synchronized execution view of T171 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
