# TASK-050 - Derived execution task
...
Deliver the outcome defined by canonical task T050: Register `NovaLeaveOptions` validation with startup failure for missing/invalid values in `src/NovaLeave.Web/Program.cs`.

## Description

This file is a generated or synchronized execution view of T050 from specs/001-leave-management-mvp/tasks.md. The canonical task source must be edited first; this file must never override canonical task IDs, objectives, dependencies, or coverage.
