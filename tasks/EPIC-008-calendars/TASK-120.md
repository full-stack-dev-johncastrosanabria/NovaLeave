# TASK-120 - Implement shared calendar query models
...
Deliver the outcome defined by canonical task T120: Implement shared calendar query models.

## Description

This task is a derived execution view of $(@{Id=120; OfficialId=T120; TaskId=TASK-120; Raw=[P] [US6] Implement shared calendar query models in `src/NovaLeave.Application/Calendars/CalendarModels.cs`; Name=Implement shared calendar query models; IsParallel=True; US=US6; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=120; OfficialId=T120; TaskId=TASK-120; Raw=[P] [US6] Implement shared calendar query models in `src/NovaLeave.Application/Calendars/CalendarModels.cs`; Name=Implement shared calendar query models; IsParallel=True; US=US6; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=120; OfficialId=T120; TaskId=TASK-120; Raw=[P] [US6] Implement shared calendar query models in `src/NovaLeave.Application/Calendars/CalendarModels.cs`; Name=Implement shared calendar query models; IsParallel=True; US=US6; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=120; OfficialId=T120; TaskId=TASK-120; Raw=[P] [US6] Implement shared calendar query models in `src/NovaLeave.Application/Calendars/CalendarModels.cs`; Name=Implement shared calendar query models; IsParallel=True; US=US6; Paths=System.Object[]}.OfficialId).
- Deliver only: Implement shared calendar query models.
- Expected files or folders:
- `src/NovaLeave.Application/Calendars/CalendarModels.cs`
...
- Planned path: `src/NovaLeave.Application/Calendars/CalendarModels.cs`
- Original task: $(@{Id=120; OfficialId=T120; TaskId=TASK-120; Raw=[P] [US6] Implement shared calendar query models in `src/NovaLeave.Application/Calendars/CalendarModels.cs`; Name=Implement shared calendar query models; IsParallel=True; US=US6; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
