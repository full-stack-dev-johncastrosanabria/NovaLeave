...
Deliver the outcome defined by canonical task T122: Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`.

## Description

This task is a derived execution view of $(@{Id=122; OfficialId=T122; TaskId=TASK-122; Raw=[US6] Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; Name=Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; IsParallel=False; US=US6; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=122; OfficialId=T122; TaskId=TASK-122; Raw=[US6] Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; Name=Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; IsParallel=False; US=US6; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=122; OfficialId=T122; TaskId=TASK-122; Raw=[US6] Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; Name=Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; IsParallel=False; US=US6; Paths=System.Object[]}.Raw).
...
- [ ] The deliverable described by $(@{Id=122; OfficialId=T122; TaskId=TASK-122; Raw=[US6] Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; Name=Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; IsParallel=False; US=US6; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=122; OfficialId=T122; TaskId=TASK-122; Raw=[US6] Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; Name=Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; IsParallel=False; US=US6; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Original task: $(@{Id=122; OfficialId=T122; TaskId=TASK-122; Raw=[US6] Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; Name=Integrate shared calendar partial into User, Approver, and HR calendar Razor views under `src/NovaLeave.Presentation.Web/Views/`; IsParallel=False; US=US6; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
