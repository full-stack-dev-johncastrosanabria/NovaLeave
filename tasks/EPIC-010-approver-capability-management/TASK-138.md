# TASK-138 - Add UC-22 capability toggle validation, rowversion, and audit tests
...
Deliver the outcome defined by canonical task T138: Add UC-22 capability toggle validation, rowversion, and audit tests.

## Description

This task is a derived execution view of $(@{Id=138; OfficialId=T138; TaskId=TASK-138; Raw=[P] [US8] Add UC-22 capability toggle validation, rowversion, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`; Name=Add UC-22 capability toggle validation, rowversion, and audit tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=138; OfficialId=T138; TaskId=TASK-138; Raw=[P] [US8] Add UC-22 capability toggle validation, rowversion, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`; Name=Add UC-22 capability toggle validation, rowversion, and audit tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=138; OfficialId=T138; TaskId=TASK-138; Raw=[P] [US8] Add UC-22 capability toggle validation, rowversion, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`; Name=Add UC-22 capability toggle validation, rowversion, and audit tests; IsParallel=True; US=US8; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=138; OfficialId=T138; TaskId=TASK-138; Raw=[P] [US8] Add UC-22 capability toggle validation, rowversion, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`; Name=Add UC-22 capability toggle validation, rowversion, and audit tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId).
- Deliver only: Add UC-22 capability toggle validation, rowversion, and audit tests.
- Expected files or folders:
- `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`
...
- [ ] The deliverable described by $(@{Id=138; OfficialId=T138; TaskId=TASK-138; Raw=[P] [US8] Add UC-22 capability toggle validation, rowversion, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`; Name=Add UC-22 capability toggle validation, rowversion, and audit tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=138; OfficialId=T138; TaskId=TASK-138; Raw=[P] [US8] Add UC-22 capability toggle validation, rowversion, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`; Name=Add UC-22 capability toggle validation, rowversion, and audit tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`
- Original task: $(@{Id=138; OfficialId=T138; TaskId=TASK-138; Raw=[P] [US8] Add UC-22 capability toggle validation, rowversion, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityToggleTests.cs`; Name=Add UC-22 capability toggle validation, rowversion, and audit tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
