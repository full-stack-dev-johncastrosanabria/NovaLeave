...
Deliver the outcome defined by canonical task T137: Add UC-22 Approver capability list tests.

## Description

This task is a derived execution view of $(@{Id=137; OfficialId=T137; TaskId=TASK-137; Raw=[P] [US8] Add UC-22 Approver capability list tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityListTests.cs`; Name=Add UC-22 Approver capability list tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=137; OfficialId=T137; TaskId=TASK-137; Raw=[P] [US8] Add UC-22 Approver capability list tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityListTests.cs`; Name=Add UC-22 Approver capability list tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=137; OfficialId=T137; TaskId=TASK-137; Raw=[P] [US8] Add UC-22 Approver capability list tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityListTests.cs`; Name=Add UC-22 Approver capability list tests; IsParallel=True; US=US8; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=137; OfficialId=T137; TaskId=TASK-137; Raw=[P] [US8] Add UC-22 Approver capability list tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityListTests.cs`; Name=Add UC-22 Approver capability list tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId).
...
- [ ] The deliverable described by $(@{Id=137; OfficialId=T137; TaskId=TASK-137; Raw=[P] [US8] Add UC-22 Approver capability list tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityListTests.cs`; Name=Add UC-22 Approver capability list tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=137; OfficialId=T137; TaskId=TASK-137; Raw=[P] [US8] Add UC-22 Approver capability list tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityListTests.cs`; Name=Add UC-22 Approver capability list tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Original task: $(@{Id=137; OfficialId=T137; TaskId=TASK-137; Raw=[P] [US8] Add UC-22 Approver capability list tests in `tests/NovaLeave.IntegrationTests/UseCases/UC22ApproverCapabilityListTests.cs`; Name=Add UC-22 Approver capability list tests; IsParallel=True; US=US8; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
