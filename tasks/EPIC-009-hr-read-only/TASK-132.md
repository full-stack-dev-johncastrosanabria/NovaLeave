# TASK-132 - Implement HR audit read queries with sensitive-reason access auditing
...
Deliver the outcome defined by canonical task T132: Implement HR audit read queries with sensitive-reason access auditing.

## Description

This task is a derived execution view of $(@{Id=132; OfficialId=T132; TaskId=TASK-132; Raw=[P] [US7] Implement HR audit read queries with sensitive-reason access auditing in `src/NovaLeave.Application/HR/Audit/`; Name=Implement HR audit read queries with sensitive-reason access auditing; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=132; OfficialId=T132; TaskId=TASK-132; Raw=[P] [US7] Implement HR audit read queries with sensitive-reason access auditing in `src/NovaLeave.Application/HR/Audit/`; Name=Implement HR audit read queries with sensitive-reason access auditing; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=132; OfficialId=T132; TaskId=TASK-132; Raw=[P] [US7] Implement HR audit read queries with sensitive-reason access auditing in `src/NovaLeave.Application/HR/Audit/`; Name=Implement HR audit read queries with sensitive-reason access auditing; IsParallel=True; US=US7; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=132; OfficialId=T132; TaskId=TASK-132; Raw=[P] [US7] Implement HR audit read queries with sensitive-reason access auditing in `src/NovaLeave.Application/HR/Audit/`; Name=Implement HR audit read queries with sensitive-reason access auditing; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId).
- Deliver only: Implement HR audit read queries with sensitive-reason access auditing.
- Expected files or folders:
- `src/NovaLeave.Application/HR/Audit/`
...
- [ ] The deliverable described by $(@{Id=132; OfficialId=T132; TaskId=TASK-132; Raw=[P] [US7] Implement HR audit read queries with sensitive-reason access auditing in `src/NovaLeave.Application/HR/Audit/`; Name=Implement HR audit read queries with sensitive-reason access auditing; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=132; OfficialId=T132; TaskId=TASK-132; Raw=[P] [US7] Implement HR audit read queries with sensitive-reason access auditing in `src/NovaLeave.Application/HR/Audit/`; Name=Implement HR audit read queries with sensitive-reason access auditing; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Application/HR/Audit/`
- Original task: $(@{Id=132; OfficialId=T132; TaskId=TASK-132; Raw=[P] [US7] Implement HR audit read queries with sensitive-reason access auditing in `src/NovaLeave.Application/HR/Audit/`; Name=Implement HR audit read queries with sensitive-reason access auditing; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
