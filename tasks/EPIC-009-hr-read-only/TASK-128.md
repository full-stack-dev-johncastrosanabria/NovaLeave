# TASK-128 - Add HR E2E read-only smoke tests
...
Deliver the outcome defined by canonical task T128: Add HR E2E read-only smoke tests.

## Description

This task is a derived execution view of $(@{Id=128; OfficialId=T128; TaskId=TASK-128; Raw=[P] [US7] Add HR E2E read-only smoke tests in `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`; Name=Add HR E2E read-only smoke tests; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=128; OfficialId=T128; TaskId=TASK-128; Raw=[P] [US7] Add HR E2E read-only smoke tests in `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`; Name=Add HR E2E read-only smoke tests; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=128; OfficialId=T128; TaskId=TASK-128; Raw=[P] [US7] Add HR E2E read-only smoke tests in `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`; Name=Add HR E2E read-only smoke tests; IsParallel=True; US=US7; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=128; OfficialId=T128; TaskId=TASK-128; Raw=[P] [US7] Add HR E2E read-only smoke tests in `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`; Name=Add HR E2E read-only smoke tests; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId).
- Deliver only: Add HR E2E read-only smoke tests.
- Expected files or folders:
- `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`
...
- [ ] The deliverable described by $(@{Id=128; OfficialId=T128; TaskId=TASK-128; Raw=[P] [US7] Add HR E2E read-only smoke tests in `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`; Name=Add HR E2E read-only smoke tests; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=128; OfficialId=T128; TaskId=TASK-128; Raw=[P] [US7] Add HR E2E read-only smoke tests in `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`; Name=Add HR E2E read-only smoke tests; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`
- Original task: $(@{Id=128; OfficialId=T128; TaskId=TASK-128; Raw=[P] [US7] Add HR E2E read-only smoke tests in `tests/NovaLeave.EndToEndTests/HR/HRReadOnlySmokeTests.cs`; Name=Add HR E2E read-only smoke tests; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
