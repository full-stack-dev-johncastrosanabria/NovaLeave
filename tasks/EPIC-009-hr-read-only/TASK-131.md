# TASK-131 - Implement HR balance and movement read queries
...
Deliver the outcome defined by canonical task T131: Implement HR balance and movement read queries.

## Description

This task is a derived execution view of $(@{Id=131; OfficialId=T131; TaskId=TASK-131; Raw=[P] [US7] Implement HR balance and movement read queries in `src/NovaLeave.Application/HR/Balances/`; Name=Implement HR balance and movement read queries; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=131; OfficialId=T131; TaskId=TASK-131; Raw=[P] [US7] Implement HR balance and movement read queries in `src/NovaLeave.Application/HR/Balances/`; Name=Implement HR balance and movement read queries; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=131; OfficialId=T131; TaskId=TASK-131; Raw=[P] [US7] Implement HR balance and movement read queries in `src/NovaLeave.Application/HR/Balances/`; Name=Implement HR balance and movement read queries; IsParallel=True; US=US7; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=131; OfficialId=T131; TaskId=TASK-131; Raw=[P] [US7] Implement HR balance and movement read queries in `src/NovaLeave.Application/HR/Balances/`; Name=Implement HR balance and movement read queries; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId).
- Deliver only: Implement HR balance and movement read queries.
- Expected files or folders:
- `src/NovaLeave.Application/HR/Balances/`
...
- [ ] The deliverable described by $(@{Id=131; OfficialId=T131; TaskId=TASK-131; Raw=[P] [US7] Implement HR balance and movement read queries in `src/NovaLeave.Application/HR/Balances/`; Name=Implement HR balance and movement read queries; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=131; OfficialId=T131; TaskId=TASK-131; Raw=[P] [US7] Implement HR balance and movement read queries in `src/NovaLeave.Application/HR/Balances/`; Name=Implement HR balance and movement read queries; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Application/HR/Balances/`
- Original task: $(@{Id=131; OfficialId=T131; TaskId=TASK-131; Raw=[P] [US7] Implement HR balance and movement read queries in `src/NovaLeave.Application/HR/Balances/`; Name=Implement HR balance and movement read queries; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
