# TASK-133 - Implement HR authorization policies
...
Deliver the outcome defined by canonical task T133: Implement HR authorization policies.

## Description

This task is a derived execution view of $(@{Id=133; OfficialId=T133; TaskId=TASK-133; Raw=[US7] Implement HR authorization policies in `src/NovaLeave.Application/Authorization/HRPolicies.cs`; Name=Implement HR authorization policies; IsParallel=False; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=133; OfficialId=T133; TaskId=TASK-133; Raw=[US7] Implement HR authorization policies in `src/NovaLeave.Application/Authorization/HRPolicies.cs`; Name=Implement HR authorization policies; IsParallel=False; US=US7; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=133; OfficialId=T133; TaskId=TASK-133; Raw=[US7] Implement HR authorization policies in `src/NovaLeave.Application/Authorization/HRPolicies.cs`; Name=Implement HR authorization policies; IsParallel=False; US=US7; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=133; OfficialId=T133; TaskId=TASK-133; Raw=[US7] Implement HR authorization policies in `src/NovaLeave.Application/Authorization/HRPolicies.cs`; Name=Implement HR authorization policies; IsParallel=False; US=US7; Paths=System.Object[]}.OfficialId).
- Deliver only: Implement HR authorization policies.
- Expected files or folders:
- `src/NovaLeave.Application/Authorization/HRPolicies.cs`
...
- [ ] The deliverable described by $(@{Id=133; OfficialId=T133; TaskId=TASK-133; Raw=[US7] Implement HR authorization policies in `src/NovaLeave.Application/Authorization/HRPolicies.cs`; Name=Implement HR authorization policies; IsParallel=False; US=US7; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=133; OfficialId=T133; TaskId=TASK-133; Raw=[US7] Implement HR authorization policies in `src/NovaLeave.Application/Authorization/HRPolicies.cs`; Name=Implement HR authorization policies; IsParallel=False; US=US7; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `src/NovaLeave.Application/Authorization/HRPolicies.cs`
- Original task: $(@{Id=133; OfficialId=T133; TaskId=TASK-133; Raw=[US7] Implement HR authorization policies in `src/NovaLeave.Application/Authorization/HRPolicies.cs`; Name=Implement HR authorization policies; IsParallel=False; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
