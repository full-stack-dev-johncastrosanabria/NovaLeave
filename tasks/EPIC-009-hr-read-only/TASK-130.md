...
Deliver the outcome defined by canonical task T130: Implement HR calendar query.

## Description

This task is a derived execution view of $(@{Id=130; OfficialId=T130; TaskId=TASK-130; Raw=[P] [US7] Implement HR calendar query in `src/NovaLeave.Application/HR/Calendar/`; Name=Implement HR calendar query; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=130; OfficialId=T130; TaskId=TASK-130; Raw=[P] [US7] Implement HR calendar query in `src/NovaLeave.Application/HR/Calendar/`; Name=Implement HR calendar query; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=130; OfficialId=T130; TaskId=TASK-130; Raw=[P] [US7] Implement HR calendar query in `src/NovaLeave.Application/HR/Calendar/`; Name=Implement HR calendar query; IsParallel=True; US=US7; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=130; OfficialId=T130; TaskId=TASK-130; Raw=[P] [US7] Implement HR calendar query in `src/NovaLeave.Application/HR/Calendar/`; Name=Implement HR calendar query; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId).
...
- [ ] The deliverable described by $(@{Id=130; OfficialId=T130; TaskId=TASK-130; Raw=[P] [US7] Implement HR calendar query in `src/NovaLeave.Application/HR/Calendar/`; Name=Implement HR calendar query; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=130; OfficialId=T130; TaskId=TASK-130; Raw=[P] [US7] Implement HR calendar query in `src/NovaLeave.Application/HR/Calendar/`; Name=Implement HR calendar query; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Original task: $(@{Id=130; OfficialId=T130; TaskId=TASK-130; Raw=[P] [US7] Implement HR calendar query in `src/NovaLeave.Application/HR/Calendar/`; Name=Implement HR calendar query; IsParallel=True; US=US7; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
