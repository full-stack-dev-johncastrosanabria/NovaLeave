...
Deliver the outcome defined by canonical task T097: Implement timeout cancellation command.

## Description

This task is a derived execution view of $(@{Id=97; OfficialId=T097; TaskId=TASK-097; Raw=[US3] Implement timeout cancellation command in `src/NovaLeave.Application/System/CancelTimedOutRequests/`; Name=Implement timeout cancellation command; IsParallel=False; US=US3; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=97; OfficialId=T097; TaskId=TASK-097; Raw=[US3] Implement timeout cancellation command in `src/NovaLeave.Application/System/CancelTimedOutRequests/`; Name=Implement timeout cancellation command; IsParallel=False; US=US3; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=97; OfficialId=T097; TaskId=TASK-097; Raw=[US3] Implement timeout cancellation command in `src/NovaLeave.Application/System/CancelTimedOutRequests/`; Name=Implement timeout cancellation command; IsParallel=False; US=US3; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=97; OfficialId=T097; TaskId=TASK-097; Raw=[US3] Implement timeout cancellation command in `src/NovaLeave.Application/System/CancelTimedOutRequests/`; Name=Implement timeout cancellation command; IsParallel=False; US=US3; Paths=System.Object[]}.OfficialId).
...
- [ ] The deliverable described by $(@{Id=97; OfficialId=T097; TaskId=TASK-097; Raw=[US3] Implement timeout cancellation command in `src/NovaLeave.Application/System/CancelTimedOutRequests/`; Name=Implement timeout cancellation command; IsParallel=False; US=US3; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=97; OfficialId=T097; TaskId=TASK-097; Raw=[US3] Implement timeout cancellation command in `src/NovaLeave.Application/System/CancelTimedOutRequests/`; Name=Implement timeout cancellation command; IsParallel=False; US=US3; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Original task: $(@{Id=97; OfficialId=T097; TaskId=TASK-097; Raw=[US3] Implement timeout cancellation command in `src/NovaLeave.Application/System/CancelTimedOutRequests/`; Name=Implement timeout cancellation command; IsParallel=False; US=US3; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
