# TASK-081 - Add UC-12 rejection reason, release, and audit tests
...
Deliver the outcome defined by canonical task T081: Add UC-12 rejection reason, release, and audit tests.

## Description

This task is a derived execution view of $(@{Id=81; OfficialId=T081; TaskId=TASK-081; Raw=[P] [US2] Add UC-12 rejection reason, release, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC12RejectRequestTests.cs`; Name=Add UC-12 rejection reason, release, and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=81; OfficialId=T081; TaskId=TASK-081; Raw=[P] [US2] Add UC-12 rejection reason, release, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC12RejectRequestTests.cs`; Name=Add UC-12 rejection reason, release, and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=81; OfficialId=T081; TaskId=TASK-081; Raw=[P] [US2] Add UC-12 rejection reason, release, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC12RejectRequestTests.cs`; Name=Add UC-12 rejection reason, release, and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=81; OfficialId=T081; TaskId=TASK-081; Raw=[P] [US2] Add UC-12 rejection reason, release, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC12RejectRequestTests.cs`; Name=Add UC-12 rejection reason, release, and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId).
- Deliver only: Add UC-12 rejection reason, release, and audit tests.
- Expected files or folders:
- `tests/NovaLeave.IntegrationTests/UseCases/UC12RejectRequestTests.cs`
...
- [ ] The deliverable described by $(@{Id=81; OfficialId=T081; TaskId=TASK-081; Raw=[P] [US2] Add UC-12 rejection reason, release, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC12RejectRequestTests.cs`; Name=Add UC-12 rejection reason, release, and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=81; OfficialId=T081; TaskId=TASK-081; Raw=[P] [US2] Add UC-12 rejection reason, release, and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC12RejectRequestTests.cs`; Name=Add UC-12 rejection reason, release, and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
...
- Planned path: `tests/NovaLeave.IntegrationTests/UseCases/UC12RejectRequestTests.cs`
