...
Deliver the outcome defined by canonical task T080: Add UC-11 approval transaction and audit tests.

## Description

This task is a derived execution view of $(@{Id=80; OfficialId=T080; TaskId=TASK-080; Raw=[P] [US2] Add UC-11 approval transaction and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC11ApproveRequestTests.cs`; Name=Add UC-11 approval transaction and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=80; OfficialId=T080; TaskId=TASK-080; Raw=[P] [US2] Add UC-11 approval transaction and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC11ApproveRequestTests.cs`; Name=Add UC-11 approval transaction and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=80; OfficialId=T080; TaskId=TASK-080; Raw=[P] [US2] Add UC-11 approval transaction and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC11ApproveRequestTests.cs`; Name=Add UC-11 approval transaction and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=80; OfficialId=T080; TaskId=TASK-080; Raw=[P] [US2] Add UC-11 approval transaction and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC11ApproveRequestTests.cs`; Name=Add UC-11 approval transaction and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId).
...
- [ ] The deliverable described by $(@{Id=80; OfficialId=T080; TaskId=TASK-080; Raw=[P] [US2] Add UC-11 approval transaction and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC11ApproveRequestTests.cs`; Name=Add UC-11 approval transaction and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId) exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to $(@{Id=80; OfficialId=T080; TaskId=TASK-080; Raw=[P] [US2] Add UC-11 approval transaction and audit tests in `tests/NovaLeave.IntegrationTests/UseCases/UC11ApproveRequestTests.cs`; Name=Add UC-11 approval transaction and audit tests; IsParallel=True; US=US2; Paths=System.Object[]}.OfficialId) and the listed requirements/use cases is preserved.
