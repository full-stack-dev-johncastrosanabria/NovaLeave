...
Deliver the outcome defined by canonical task T088: [US2] Implement approval command converting reservation to deduction atomically in `src/NovaLeave.Application/Approvals/ApproveRequest/`.
...
The task exists to make canonical backlog item T088 executable without changing the approved scope. Original canonical text: [US2] Implement approval command converting reservation to deduction atomically in `src/NovaLeave.Application/Approvals/ApproveRequest/`.
