# TASK-060 - Add UC-02 role context switching integration tests
...
- Deliver only: Add UC-02 role context switching integration tests.
- Expected files or folders:
- `tests/NovaLeave.IntegrationTests/UseCases/UC02SwitchRoleContextTests.cs`
...
- Planned path: `tests/NovaLeave.IntegrationTests/UseCases/UC02SwitchRoleContextTests.cs`
- Original task: $(@{Id=60; OfficialId=T060; TaskId=TASK-060; Raw=[P] [US1] Add UC-02 role context switching integration tests in `tests/NovaLeave.IntegrationTests/UseCases/UC02SwitchRoleContextTests.cs`; Name=Add UC-02 role context switching integration tests; IsParallel=True; US=US1; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
