...
Deliver the outcome defined by canonical task T075: [US1] Implement dedicated User ViewModels in `src/NovaLeave.Presentation.Web/Models/User/`.

## Description

This task is a derived execution view of T075 from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item T075 executable without changing the approved scope. Original canonical text: [US1] Implement dedicated User ViewModels in `src/NovaLeave.Presentation.Web/Models/User/`.
...
- Preserve the original canonical task identifier T075.
...
- [ ] The deliverable described by T075 exists in the planned path or documented artifact.
- [ ] Required test or evidence demonstrates the deliverable matches the approved source artifacts.
- [ ] Traceability to T075 and the listed requirements/use cases is preserved.
...
- Original task: T075 from specs/001-leave-management-mvp/tasks.md.
