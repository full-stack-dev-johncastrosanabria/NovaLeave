...
Deliver the outcome defined by canonical task T109: Add UC-17 accrual integration tests.

## Description

This task is a derived execution view of $(@{Id=109; OfficialId=T109; TaskId=TASK-109; Raw=[P] [US5] Add UC-17 accrual integration tests in `tests/NovaLeave.IntegrationTests/UseCases/UC17MonthlyAccrualTests.cs`; Name=Add UC-17 accrual integration tests; IsParallel=True; US=US5; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md. Implement or produce only the work explicitly described by the canonical task and the approved source artifacts.

## Context

The task exists to make canonical backlog item $(@{Id=109; OfficialId=T109; TaskId=TASK-109; Raw=[P] [US5] Add UC-17 accrual integration tests in `tests/NovaLeave.IntegrationTests/UseCases/UC17MonthlyAccrualTests.cs`; Name=Add UC-17 accrual integration tests; IsParallel=True; US=US5; Paths=System.Object[]}.OfficialId) executable without changing the approved scope. Original canonical text: $(@{Id=109; OfficialId=T109; TaskId=TASK-109; Raw=[P] [US5] Add UC-17 accrual integration tests in `tests/NovaLeave.IntegrationTests/UseCases/UC17MonthlyAccrualTests.cs`; Name=Add UC-17 accrual integration tests; IsParallel=True; US=US5; Paths=System.Object[]}.Raw).
...
- Preserve the original canonical task identifier $(@{Id=109; OfficialId=T109; TaskId=TASK-109; Raw=[P] [US5] Add UC-17 accrual integration tests in `tests/NovaLeave.IntegrationTests/UseCases/UC17MonthlyAccrualTests.cs`; Name=Add UC-17 accrual integration tests; IsParallel=True; US=US5; Paths=System.Object[]}.OfficialId).
...
- Original task: $(@{Id=109; OfficialId=T109; TaskId=TASK-109; Raw=[P] [US5] Add UC-17 accrual integration tests in `tests/NovaLeave.IntegrationTests/UseCases/UC17MonthlyAccrualTests.cs`; Name=Add UC-17 accrual integration tests; IsParallel=True; US=US5; Paths=System.Object[]}.OfficialId) from specs/001-leave-management-mvp/tasks.md.
